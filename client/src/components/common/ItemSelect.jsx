...
// Optional inventory-item picker for an invoice or bill line.
//
// Why optional: most lines are services, fees or free text and have no stock.
// Leaving this as "— none —" keeps the line exactly as it always was. Choosing an
// item links the line to inventory, so POSTING the document automatically moves
// stock (an invoice issues it, a bill receives it) — see utils/inventoryService.js
// postStockForInvoice / postStockForBill.
//
