...
app.use('/api/payment',     tm,  paymentGwRoutes);   // Paystack: initialize, verify, status
...
app.use('/api/reconciliation',   tm, es,   reconciliationRoutes);
app.use('/api/currencies',      tm, es,   currencyRoutes);
